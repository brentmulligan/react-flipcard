...
describe('react-flipcard', function() {
  // No clue what is going on here right now. It throws the error but it won't catch.
  it.skip('should throw an error if less than 2 children are provided', function() {
    throws(function() {
